...
class PromptCondAudioDiffusion(nn.Module):
    def __init__(
        ...
        path_pre=os.path.join(folder_paths.models_dir,"SongGeneration/ckpt/models--lengyue233--content-vec-best/snapshots/c0b9ba13db21beaa4053faae94c102ebe326fd68")
        ...
        self.hubert = HubertModelWithFinalProj.from_pretrained(path_pre)
