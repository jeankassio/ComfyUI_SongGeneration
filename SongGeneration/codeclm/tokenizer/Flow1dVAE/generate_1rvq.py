...
class Tango:
    def __init__(self, \
        ...
        main_config = {
            ...
            "unet_model_config_path":"custom_nodes/ComfyUI_SongGeneration/SongGeneration/codeclm/tokenizer/Flow1dVAE/configs/models/transformer2D_wocross_inch112_1x4_multi_large.json",
            "snr_gamma":None,
        }
